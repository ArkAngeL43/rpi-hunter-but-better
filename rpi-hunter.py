...
def list():
	...
	print("Specify with --payload", "green"), colored("name\n", "yellow")
	for key,value in payloads.items():
		print(Fore.RED+"['+key+']', 'yellow'), colored(value, 'white' ")
	print('\n')
...
def rpi():
	...
	while i < len(lines):
		print(Fore.MAGENTA+"sending payload to ", "yellow"), (lines[i], )
		if args.safe:
...
def art():
		...
		print(Fore.RED+"                                                                                      #> V1.5")
		print(Fore.RED+"-----------------------------------------------------------------------------")
		print(Fore.RED+" Fixed by ArkAngeL43 For python3                                           ")
		print(Fore.RED+"-----------------------------------------------------------------------------")
		print('\n')
		print(Fore.YELLOW+"==============================LOCAL NET SCAN==================================")
